[![Build status](https://ci.appveyor.com/api/projects/status/tej8r5y1vumuvyc3?svg=true)](https://ci.appveyor.com/project/Gto1103/ra-props-films)

![Страница проекта](https://gto1103.github.io/ra-props-films/)

Рейтинг фильмов
===

Необходимо реализовать компонент отображающий рейтинг фильма в виде звезд:
![Список фильмов](https://github.com/netology-code/ra16-homeworks/blob/master/props/films/assets/preview.png?raw=true)
